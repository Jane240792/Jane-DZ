...
//
//     let startNumber = ticket.substring(0, 3);
//     let endNumber = ticket.substring(3, 5);
//
//     let sumStartNumber = parseInt(ticket[0]) + parseInt(ticket[1]) + parseInt(ticket[2]);
//     let sumEndNumber = parseInt(ticket[3]) + parseInt(ticket[4]) + parseInt(ticket[5]);
//
//     if( sumStartNumber === sumEndNumber ) {
//         luckyTicket ++
//     }
//
// }
// console.log(luckyTicket); // 55252